            ...
            <div className="home_Parts">
              <div className="side left">
                ...
                <div className="actions_home">
                  <button className="req">تصاميم السير الذاتية</button>
                ...
                <div className="all_clints">
                  ...
                  <div className="clints">
                    <div className="clint">
                      ...
                      <h2 className="Ar">
                        <i className="fa-solid fa-cloud-arrow-down"></i> عدد
                        تحميلات <span>({download && download.length})</span>
                      </h2>
                    </div>
                    <div className="clint">
                      {/* <img src="/Images/client-2.svg" alt="2"/> */}
                      <h2 className="Ar">
                        <i className="fa-solid fa-user"></i> عدد مستخدمين{" "}
                    ...
                    <div className="clint">
                      ...
                      <h2 className="Ar">
                        <i className="fa-solid fa-file-lines"></i> عدد تصاميم{" "}
