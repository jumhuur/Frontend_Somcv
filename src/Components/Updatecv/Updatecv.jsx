        ...
        <div className="container_login">
            <div className="login_card">
                <form className="login_from">
                    ...
                    <input  value={cvinfo && cvinfo.Magac} onChange={Onchange_inputs} type={"text"} placeholder="Magacaaga" name="Magac"/>
                    <input  value={cvinfo && cvinfo.Qiimaha} onChange={Onchange_inputs} type={"number"} placeholder="Price" name="Qiimaha"/>
                    ...
                    <button type="submit" onClick={addcv}  className="submit_btn"><Link>Update</Link></button>
                    {qalad && 
