            ...
            <div className="login_card">
                <form className="login_from">
                    <span className="welcome">
                        شكل سيرة ذاتية جديدة
                    </span>
                    <input onChange={Onchange_inputs} type={"text"} placeholder="اسم " name="Name"/>
                    <input onChange={Onchange_inputs} type={"number"} placeholder="القيمة" name="Price"/>
                    ...
                    <button onClick={addcv} className="submit_btn"><Link to={'/ar'}>Add Cv</Link></button>
                    {qalad && 
