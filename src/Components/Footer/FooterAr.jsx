            ...
            <div className="haye">
                    ...
                    <div className="links_footer">
                        <ul className="footer_links">
                            <li className="footer_links_items">
                                <Link to={"/"}>
                                    <span><i className="fa-solid fa-file-lines"></i></span> شروط الإستخدام
                                </Link>
                            </li>
                            <li className="footer_links_items">
                            <Link to={"/ar/register"}>
                            <span><i className="fa-solid fa-user"></i></span> حساب جديد
                            </Link>
                            </li>
                            <li className="footer_links_items">
                            <Link to={"/ar/Login"}>
                            <span><i className="fa-solid fa-right-to-bracket"></i></span> تسجيل الدخول
                            </Link>
                            </li>
                            <li className="footer_links_items">
                            <Link to={"/"}>
                            <span><i className="fa-solid fa-compress"></i></span> خدمات
                            </Link>
                            </li>
                        </ul>
                    </div>
                ...
                <div className="parts_footer">
                    <div className="contect_us_footer">
                        <h2 className="ciwaan_footer" style={{textAlign:"right"}}>24/7</h2>
