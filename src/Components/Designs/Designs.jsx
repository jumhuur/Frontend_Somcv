        ...
        <div className="haye ciwaan">
          <div className="ciwaan_adv">
            <h2>
              {" "}
              <span>
                <i className="fa-solid fa-parachute-box"></i> ready{" "}
              </span>{" "}
              designs
            </h2>
          </div>
          ...
          <div className="designs">
              ...
              cv.map((cvdata) => (
                <div className="design" key={cvdata._id}>
                  <div className="info_design">
                    ...
                    <p>
                      <i className="fa-solid fa-dollar-sign"></i> 0
                      {cvdata.Qiimaha} USD
                    </p>
                  </div>
                  <Link to={`/?id=${cvdata._id}`} className="ankar_poin">
                    <button className="P_previews" onClick={click}>
            ...
            {!cv &&
              [0, 1, 2, 3, 4, 5, 6, 7, 8].map((Num) => <Cvskl key={Num} />)}
          </div>
        </div>
      </div>
    </>
