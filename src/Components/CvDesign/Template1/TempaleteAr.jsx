...
import Styletemp1 from "./Template1Ar.module.css"
import React from "react";
function TemplateAr({color1,color2}){
        ...
        <div className={Styletemp1.page_cv_container} dir="rtl">
            <div className={Styletemp1.cv_doc} style={{backgroundColor: `${color1}`}}>
                <div className={Styletemp1.image_and_name}>
                    ...
                    <h3 style={{color: `${color2}`}} className={Styletemp1.Jobtitle} >{CrentUser ? info.Jobtitle : "غنوان الوظيفة"}</h3>
                    ...
                    <div className={Styletemp1.person_contects}>
                        ...
                        <ul className={Styletemp1.ul_contect}>
                            ...
                            <i style={{color: `${color2}`}} className="fa-solid fa-location-dot"></i> {CrentUser ? info.Location : "وطن | المدية"}
                            </li>
                    ...
                    <div className={`${Styletemp1.person_contects} ${Styletemp1.edecation}`}>
                        ...
                        <div className={Styletemp1.heer_waxbrasho}>
                            ...
                            <h4 style={{color: `${color2}`}} className={Styletemp1.Ciwaan_hoose}><i className="fa-solid fa-graduation-cap"></i> {CrentUser ? info.Edunivername1 : "اسم الجه التعليمية"}</h4>
                        </div>
                        <div className={Styletemp1.heer_waxbrasho}>
                            ...
                            <h4 style={{color: `${color2}`}} className={Styletemp1.Ciwaan_hoose}><i className="fa-solid fa-graduation-cap"></i> {CrentUser ? info.Edunivername2 : "اسم الجه التعليمية"}</h4>
                        </div>
                        <div className={Styletemp1.heer_waxbrasho}>
                            ...
                            <h4 style={{color: `${color2}`}} className={Styletemp1.Ciwaan_hoose}><i className="fa-solid fa-graduation-cap"></i> {CrentUser ? info.Edunivername3 : "اسم الجه التعليمية"}</h4>
                        </div>
                    </div>
                    <div className={Styletemp1.qurxin}>
                        <span></span>
            ...
            <div className={Styletemp1.work_info}>
                <div className={`${Styletemp1.sections} ${Styletemp1.Profile}`}>
                    <h3 style={{color: color2}} className={Styletemp1.ciwaano_left}>نبدة عني</h3>
                    <p className={Styletemp1.qoraal_hoose} style={{textAlign: "right"}}>
                ...
                <div className={`${Styletemp1.sections} ${Styletemp1.Exprians}`}>
                    <h3  style={{color: color2}} className={Styletemp1.ciwaano_left}>الحبرات </h3>
                    <div className={Styletemp1.exp}>
                        <div className={`${Styletemp1.qayb} ${Styletemp1.date_compny}`}>
                            ...
                            <h4  className={Styletemp1.Ciwaan_hoose}><i className="fa-solid fa-building"></i> {CrentUser ? info.Excompnay1 : "اسم الشركة"}</h4>
                        </div>
                        <div className={`${Styletemp1.qayb} ${Styletemp1.info}`}>
                            <h4 style={{color: color2}} className={Styletemp1.Ciwaan_hoose}>{CrentUser ? info.Exjob1 : "عنوان الوظيفة"}</h4>
                            <p className={Styletemp1.qoraal_hoose} style={{textAlign: "right"}}>
                    ...
                    <div className={Styletemp1.exp}>
                        <div className={`${Styletemp1.qayb} ${Styletemp1.date_compny}`}>
                            ...
                            <h4 className={Styletemp1.Ciwaan_hoose}><i className="fa-solid fa-building"></i> {CrentUser ? info.Excompnay2 : "اسم الشركة"} </h4>
                        </div>
                        <div className={`${Styletemp1.qayb} ${Styletemp1.info}`}>
                            <h4 style={{color: color2}} className={Styletemp1.Ciwaan_hoose}>{CrentUser ? info.Exjob2 : "عنوان الوظيفة"}</h4>
                            <p className={Styletemp1.qoraal_hoose} style={{textAlign: "right"}}>
                    ...
                    <div className={Styletemp1.exp}>
                        <div className={`${Styletemp1.qayb} ${Styletemp1.date_compny}`}>
                            ...
                            <h4 className={Styletemp1.Ciwaan_hoose}><i className="fa-solid fa-building"></i> {CrentUser ? info.Excompnay3 : "اسم الشركة"} </h4>
                        </div>
                        <div className={`${Styletemp1.qayb} ${Styletemp1.info}`}>
                            <h4 style={{color: color2}} className={Styletemp1.Ciwaan_hoose}>{CrentUser ? info.Exjob3 : "عنوان الوظيفة"}</h4>
                            <p className={Styletemp1.qoraal_hoose} style={{textAlign: "right"}}>
                ...
                <div className={`${Styletemp1.sections} ${Styletemp1.Exprians}`}>
                    <h3  style={{color: color2}}  className={Styletemp1.ciwaano_left}>الحرف</h3>
                    <div className={Styletemp1.exp}>
                ...
                <div className={`${Styletemp1.sections} ${Styletemp1.Interest}`}>
                    <h3 style={{color: color2}} className={Styletemp1.ciwaano_left}>هواياتك</h3>
                    <ul className={Styletemp1.interst}>
                        <li className={Styletemp1.lits_inters}>
                        <i style={{color: color2}} className="fa-solid fa-circle-dot"></i> {CrentUser  ? info.Inters1 : "الهواية"} 
                        </li>
                        <li className={Styletemp1.lits_inters}>
                        <i style={{color: color2}} className="fa-solid fa-circle-dot"></i> {CrentUser  ? info.Inters2 : "الهواية"} 
                        </li>
                        <li className={Styletemp1.lits_inters}>
                        <i style={{color: color2}} className="fa-solid fa-circle-dot"></i> {CrentUser  ? info.Inters3 : "الهواية"} 
                        </li>
                        <li className={Styletemp1.lits_inters}>
                        <i style={{color: color2}} className="fa-solid fa-circle-dot"></i> {CrentUser  ? info.Inters4 : "الهواية"}
                        </li>
